  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-muted/50 to-background">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        ...
        >
          <motion.h1 
            className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-foreground via-primary to-foreground bg-clip-text text-transparent leading-tight"
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        ...
        >
          <motion.div variants={cardVariants} whileHover="hover">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-card to-card/50 h-full">
              <CardHeader>
        ...
        >
          <Card className="max-w-3xl mx-auto border-0 shadow-xl transition-all duration-300 hover:shadow-2xl group bg-gradient-to-br from-card via-card to-primary/5">
            <CardHeader className="pb-6">
              ...
              >
                <CardTitle className="text-3xl md:text-4xl bg-gradient-to-r from-foreground to-primary bg-clip-text text-transparent">
        ...
        >
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex gap-6">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/service" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Terms of Service
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="mailto:contact@nandan.fyi" className="text-sm text-muted-foreground hover:text-foreground transition-colors duration-200">
                  Contact Us
                </Link>
              </motion.div>
            </div>
