          ...
          <CardContent className="p-8 space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                By accessing and using Friday AI Calendar ("the Service"), you accept and agree to be bound by the terms 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                Friday AI Calendar is an intelligent calendar management platform that helps users organize their schedules, 
                manage events, and integrate with various calendar services. The Service includes:
              </p>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Service and its original content, features, and functionality are owned by Friday AI Calendar and are 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                The Service may integrate with third-party services (such as Google Calendar). Your use of these 
                integrations is subject to the respective third-party terms and privacy policies. We are not responsible 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                To the maximum extent permitted by law, Friday AI Calendar shall not be liable for any indirect, 
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                particular purpose, or non-infringement. We do not warrant that the Service will be error-free or 
                uninterrupted.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                Service will cease immediately, and we may delete your account and data.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="bg-muted/50 p-4 rounded-lg">
                <p className="text-sm text-muted-foreground">
                  <strong>Email:</strong> contact@nandan.fyi<br />
                </p>
              </div>
            </div>
            ...
            <div className="text-center pt-4">
              <p className="text-sm text-muted-foreground mb-6">
                By using Friday AI Calendar, you acknowledge that you have read, understood, and agree to be bound by these Terms of Service.
              </p>
