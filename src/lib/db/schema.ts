...
export const notifications = pgTable("notifications", {
  ...
  type: text("type").notNull(), // e.g., "event_reminder", "event_update", "system"
  eventId: text("event_id"), // optional reference to event
  ...
  readAt: timestamp("read_at"), // when the user read the notification
  createdAt: timestamp("created_at").defaultNow().notNull(),
  updatedAt: timestamp("updated_at").defaultNow().notNull(),
})
