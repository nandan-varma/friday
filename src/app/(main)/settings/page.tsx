            ...
            <CardContent>
              <form action={handleSettingsSubmit} className="space-y-6">
                ...
                <input
                  ...
                  value={
                    settingsForm.notificationsEnabled?.toString() || "true"
                  }
                />
                <input
                  type="hidden"
                  ...
                  value={
                    settingsForm.aiSuggestionsEnabled?.toString() || "true"
                  }
                />
                <input
                  type="hidden"
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={settingsForm.timezone || "UTC"}
                    onValueChange={(value) =>
                      setSettingsForm((prev) => ({ ...prev, timezone: value }))
                    }
                    name="timezone"
                  >
                    <SelectTrigger>
                ...
                <div className="space-y-4">
                  <Alert>
                    ...
                    <AlertDescription>
                      ...
                      your schedule across platforms.
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="text-center py-8">
                    ...
                    <p className="text-muted-foreground mb-4 max-w-md mx-auto">
                      Sync your Google Calendar events with Friday for a unified
