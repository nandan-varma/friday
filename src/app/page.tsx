      ...
      >
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-2xl font-bold bg-linear-to-r from-foreground to-primary bg-clip-text text-transparent">Friday</span>
          </motion.div>
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        ...
        >
          <motion.h2 
            ...
            variants={itemVariants}
          >
            Features that <span className="bg-linear-to-r from-primary to-primary/70 bg-clip-text text-transparent">save you time</span>
          </motion.h2>
          <motion.p 
