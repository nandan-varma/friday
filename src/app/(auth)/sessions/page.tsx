...
interface SessionCardProps {
  ...
  detectDeviceType: (userAgent?: string | null) => {
    type: string;
...
function SessionCard({
  ...
  return (
    <Card
      className={`transition-all hover:shadow-md ${isExpired ? "opacity-60" : ""}`}
    >
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-3">
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-lg">
                  {browserName} on{" "}
                  {deviceInfo.type === "mobile" ? "Mobile" : "Desktop"}
                </CardTitle>
              </div>
                    ...
                    <p className="text-2xl font-bold text-primary">
                      {
                        sessions.filter(
                          (s) =>
                            detectDeviceType(s.userAgent).type === "mobile",
                        ).length
                      }
                    </p>
                  </div>
                    ...
                    <p className="text-2xl font-bold text-primary">
                      {
                        sessions.filter(
                          (s) =>
                            detectDeviceType(s.userAgent).type === "desktop",
                        ).length
                      }
                    </p>
                  </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-destructive">
                      {
                        sessions.filter((s) => isSessionExpired(s.expiresAt))
                          .length
                      }
                    </p>
                  </div>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="text-sm text-muted-foreground">
                  <p>
                    💡 <strong>Security tip:</strong> Regularly review and
                    revoke unused sessions to keep your account secure.
                  </p>
                </div>
              </div>
            </CardContent>
