...
export function AllDayEventBar({ event, onEdit, onDelete, draggable, style }: AllDayEventBarProps) {
  ...
  return (
    ...
    >
      <span className="inline-flex items-center gap-1">
        {event.recurringEventId && <Repeat className="h-2.5 w-2.5 shrink-0 opacity-70" />}
