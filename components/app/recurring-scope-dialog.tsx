...
const ACTION_COPY: Record<RecurringScopeDialogProps["action"], { title: string; verb: string }> = {
...
export function RecurringScopeDialog({ open, action, onOpenChange, onChoose }: RecurringScopeDialogProps) {
    ...
    <AlertDialog open={open} onOpenChange={onOpenChange}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            This is part of a recurring series. Apply this {verb} to just this event, or to every event in the series?
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          ...
          <AlertDialogAction onClick={() => onChoose("series")}>All events</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
  )
