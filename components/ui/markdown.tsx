...
const MarkdownRenderer = memo<MarkdownProps>(({ content, className, isUserMessage = false }) => {
  ...
  return (
    <div className={cn(
      ...
      "[&_h1]:text-xl [&_h1]:font-bold [&_h1]:mb-3 [&_h1]:mt-4 [&_h1]:first:mt-0",
      "[&_h2]:text-lg [&_h2]:font-semibold [&_h2]:mb-2 [&_h2]:mt-3 [&_h2]:first:mt-0",
      "[&_h3]:text-base [&_h3]:font-semibold [&_h3]:mb-2 [&_h3]:mt-3 [&_h3]:first:mt-0",
      "[&_hr]:border-border [&_hr]:my-4",
      "[&_table]:border-collapse [&_table]:w-full",
      "[&_th]:border [&_th]:border-border [&_th]:px-2 [&_th]:py-1 [&_th]:bg-muted [&_th]:font-semibold",
      "[&_td]:border [&_td]:border-border [&_td]:px-2 [&_td]:py-1",
      isUserMessage && "[&_*]:text-primary-foreground",
      className
    )}>
      <ReactMarkdown
        components={{
